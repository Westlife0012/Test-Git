...
//		
	...
	public void StateJudge(){
		if (!_info.IsName("Idle") && !_info.IsName("Run")&& _info.normalizedTime>1.2f){
			
			_state = State.Idle;
			
			Debug.Log("sfdsjfjdskfdskjdkls");
		}
		...
		if (_info.IsName("Attack2") && _hitCount==2 && _info.normalizedTime>1f)
		{
